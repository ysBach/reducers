...
<code>[]{.parameter-name} [:]{.parameter-annotation-sep} [minimum, maximum : scalar or ndarray]{.parameter-annotation}</code>

:   Pair of reduction results. ``axis=None`` uses a fused one-pass Rust kernel. Axis reductions currently compute the minimum and maximum as separate reductions.
